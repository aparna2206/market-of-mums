...
if($_GET['cat_id'] !=''){
	if($_POST['Submit'] == "Publish"){
		...
		if($u->updateCategory($_POST)){
			$msg = "<span class=\"message\">Category Updated successfully.</span>";
		}else{
			$msg = "<span class=\"error\">Unable to Update category.</span>";
		}
	}
	$category = $u->getCategoryDetails($_GET['cat_id']);
}
?>
<!DOCTYPE html>
							...
							<div class="form-horizontal form-bordered">	
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
                                                                                    <input type="text" id="category" name="category" class="form-control" placeholder="Category" value="<?php if($category['category']!=''){echo $category['category'];}?>" required>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-offset-2 col-md-10">
													...
													<button type="button" id="back-btn" class="btn btn-default" onclick="window.location.href='all_language.php'">Back</button> 
