		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title pull-right">
                                    <div class="addbanhead"><a href="add_member.php"><img src="img/addnew_btn.png"></a></div>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-doc"></i>All User Details
							</div>
						</div>
						...
						<?php foreach($admins as $ad){ ?>	
							<tr>
								...
								<td>
									 <a href="edit_member.php?char_id=<?php  echo $ad['id'];?>"><img src="img/editgrid.png"></a> | <a href="javascript:confirmChoice('<?php echo $lid;?>')"><img src="img/deletegrid.png"></a>
								</td>
							</tr>
						<?php } ?>
							</tbody>
