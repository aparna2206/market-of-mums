...
if($_POST['Submit'] == "Publish")
{
	...
	if($u->addSubCategory($_POST)){
		$msg = "<span class=\"message\">Sub-Category Added Successfully.</span>";
	}else{
		$msg = "<span class=\"error\">Unable to add Sub Category.</span>";
	}
}
							...
							<div class="form-horizontal form-bordered">	
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-10">
                                                                                    <input type="text" id="sub_category" name="sub_category" class="form-control" placeholder="Category" value="" required>
										</div>
