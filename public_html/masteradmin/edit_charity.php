...
if($_GET['char_id'] !=''){
	if($_POST['Submit'] == "Publish"){
		...
		if($u->updatecharity($_POST)){
			$msg = "<span class=\"message\">Charity Updated Successfully.</span>";
		}else{
			$msg = "<span class=\"error\">Unable to Update Charity.</span>";
		}
	}
	$charity = $u->getCharityDetails($_GET['char_id']);
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
                                                            <i class="icon-doc"></i> Charity Details
							</div>
						</div>
							...
							<div class="form-horizontal form-bordered">	
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-2">Charity Name <span class="require"> * </span></label>
										<div class="col-md-10">
                                                                                    <input type="text" id="charity" name="charity" class="form-control" placeholder="Charity name" value="<?php if($charity['name']!=''){echo $charity['name'];}?>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
                                                                                    <input type="text" id="details" name="details" class="form-control" placeholder="Description" value="<?php if($charity['description']!=''){echo $charity['description'];}?>" required>
										</div>
									</div>
								</div>
							</div>
											...
											<div class="form-group last">
												...
												<div class="col-md-10">
													<select class="form-control" id="lstatus" name="lstatus">
														<option value="1" <?php if($charity['is_active']=="1"){echo "Selected";}?>> Active </option>
														<option value="0" <?php if($charity['is_active']=="0"){echo "Selected";}?>> Inactive </option>
													</select>
												</div>
											</div>
										</div>									
