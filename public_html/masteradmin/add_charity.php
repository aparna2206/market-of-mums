...
if($_POST['Submit'] == "Publish")
{
	...
	if($u->addCharity($_POST)){
		$msg = "<span class=\"message\">Charity Addedd Successfully.</span>";
	}else{
		$msg = "<span class=\"error\">Unable to add charity.</span>";
	}
}
?>
<!DOCTYPE html>
							...
							<div class="form-horizontal form-bordered">	
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-10">
                                                                                    <input type="text" id="language" name="charity" class="form-control" placeholder="Enter Charity name" value="" required="">
										</div>
                                                                                <label class="control-label col-md-2">Details <span class="require"> * </span></label>
                                                                                <div class="col-md-10">
                                                                                    <input type="text" id="language" name="Details" class="form-control" placeholder="Enter Desciption" value="" required>
										</div>
									</div>
								</div>
							</div>
